"""
Together AI Provider - Tier 1 ($0.20-0.80/M tokens)

Optimized for cost-effective inference with models like:
- meta-llama/Llama-3.1-8B-Instruct-Turbo ($0.18/M input, $0.18/M output)
- meta-llama/Llama-3.1-70B-Instruct-Turbo ($0.88/M input, $0.88/M output)
- mistralai/Mixtral-8x7B-Instruct-v0.1 ($0.60/M input, $0.60/M output)
"""
...
class TogetherProvider(LLMProvider):
    ...
    Features:
    - Competitive pricing (often cheapest for Llama models)
    ...
    async def chat_completion(
        ...
        **kwargs
        ...
        """
        Generate chat completion using Together API.

        Args:
            model: Model name (e.g., "meta-llama/Llama-3.1-8B-Instruct-Turbo")
            messages: List of message dicts with 'role' and 'content'
            temperature: Sampling temperature (0.0-2.0)
            max_tokens: Max tokens to generate
            stream: Whether to stream response (not used for non-streaming)
            **kwargs: Additional API parameters (top_p, top_k, repetition_penalty, etc.)
    ...
    async def stream_completion(
        ...
        **kwargs
        ...
        """
        Stream completion chunks from Together API.
    ...
    async def health_check(self) -> bool:
        """
        Check if Together API is healthy.
        ...
        try:
            ...
            # Together API has a /models endpoint
    ...
    def get_cost(self, input_tokens: int, output_tokens: int, model: str = None) -> float:
        ...
        Args:
            ...
            model: Model name (defaults to Llama-3.1-8B-Instruct-Turbo)
        ...
        input_price, output_price = self.PRICING.get(
            model,
            (0.18, 0.18)  # Default to cheapest model pricing
        )
...
if __name__ == "__main__":
    async def main():
        ...
        print(f"Together health: {is_healthy}")
